...
export default function Home() {
  ...
  const menuItems = [
    ...
    { label: 'Отзывы', ref: testimonialsRef },
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <header className={`fixed top-0 w-full z-50 transition-all duration-300 ${scrolled ? 'bg-white shadow-md' : 'bg-white'}`}>
        <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2 md:gap-3">
            <a href="tel:+79261692970" className="flex items-center gap-1 md:gap-2 text-gray-700 hover:text-[#0f5a6b] transition-colors">
              <Phone size={16} />
              <span className="text-xs md:text-sm font-medium">+7 926 169-29-70</span>
            </a>
            
            <MessengerLink href="https://t.me/79261692970?text=%D0%97%D0%B4%D1%80%D0%B0%D0%B2%D1%81%D1%82%D0%B2%D1%83%D0%B9%D1%82%D0%B5!%20%D0%9C%D0%BD%D0%B5%20%D0%B8%D0%BD%D1%82%D0%B5%D1%80%D0%B5%D1%81%D0%BD%D1%8B%20%D0%B2%D0%B0%D1%88%D0%B8%20%D1%83%D1%81%D0%BB%D1%83%D0%B3%D0%B8." icon="telegram" label="Telegram" className="hidden md:inline-flex" />
            <MessengerLink href="https://wa.me/79261692970?text=%D0%97%D0%B4%D1%80%D0%B0%D0%B2%D1%81%D1%82%D0%B2%D1%83%D0%B9%D1%82%D0%B5!%20%D0%9C%D0%BD%D0%B5%20%D0%B8%D0%BD%D1%82%D0%B5%D1%80%D0%B5%D1%81%D0%BD%D1%8B%20%D0%B2%D0%B0%D1%88%D0%B8%20%D1%83%D1%81%D0%BB%D1%83%D0%B3%D0%B8." icon="whatsapp" label="WhatsApp" className="hidden md:inline-flex" />
            ...
            <nav className="absolute right-0 top-0 h-full w-64 bg-white shadow-lg animate-in slide-in-from-right-full duration-300">
              <div className="p-6 space-y-4">
                ...
                <div className="flex gap-3 pt-4 border-t">
                  <MessengerLink href="https://t.me/79261692970?text=%D0%97%D0%B4%D1%80%D0%B0%D0%B2%D1%81%D1%82%D0%B2%D1%83%D0%B9%D1%82%D0%B5!%20%D0%9C%D0%BD%D0%B5%20%D0%B8%D0%BD%D1%82%D0%B5%D1%80%D0%B5%D1%81%D0%BD%D1%8B%20%D0%B2%D0%B0%D1%88%D0%B8%20%D1%83%D1%81%D0%BB%D1%83%D0%B3%D0%B8." icon="telegram" label="Telegram" />
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-gray-600 leading-relaxed">
                  Компания специализируется на комплексном оснащении медицинских, государственных и образовательных учреждений. Реализуются проекты «под ключ» — от анализа технического задания до поставки, монтажа и ввода оборудования в эксплуатацию.
                </p>
              </div>
              <div>
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg border-l-4 border-[#0f5a6b]">
              ...
              <ul className="space-y-4">
                <li className="flex gap-3">
                  ...
                  <span className="text-gray-600">Молодая и амбициозная команда профессионалов</span>
                </li>
                <li className="flex gap-3">
                  <span className="text-[#0f5a6b] font-bold text-lg">✓</span>
      ...
      <section className="py-20 bg-[#0f5a6b] border-t-8 border-[#0f5a6b]">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <Counter target={2024} label="год основания" suffix="" />
            <Counter target={15} label="проектов за последний год" suffix="+" />
            <Counter target={200} label="помещений оснащено" suffix="+" />
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {[
              { 
                ...
                img: '/project-clinic-before.jpg',
                duration: '3 месяца',
                budget: 'Оптимизированный бюджет',
                description: 'Полная комплектация медицинского оборудования'
              },
              { 
                title: 'Лаборатория медицинского анализа', 
                img: '/project-hospital-lab.jpg',
                duration: '2 месяца',
                budget: 'Оптимизированный бюджет',
              ...
              { 
                ...
                img: '/project-education-center.jpg',
                duration: '4 месяца',
                budget: 'Оптимизированный бюджет',
      ...
      <section ref={testimonialsRef} className="py-20 bg-white border-t-8 border-[#0f5a6b]">
        <div className="max-w-7xl mx-auto px-4">
          <h2 className="text-4xl font-bold text-gray-900 mb-12 text-center">Отзывы клиентов</h2>
          <div className="grid md:grid-cols-3 gap-8">
            {[
              { name: 'Иван Петров', company: 'Клиника "Здоровье"', text: 'Отличная работа! Команда профессионалов выполнила все в срок и с высочайшим качеством. Рекомендуем!' },
              { name: 'Мария Сидорова', company: 'Школа №15', text: 'Спасибо за внимание к деталям и быстрое решение всех вопросов. Оборудование работает идеально!' },
              { name: 'Александр Иванов', company: 'Офис "Инновация"', text: 'Профессиональный подход и честные цены. Это именно то, что нам было нужно. Спасибо!' },
            ].map((testimonial, i) => (
              <div key={i} className="bg-gray-50 p-8 rounded-lg shadow-md">
